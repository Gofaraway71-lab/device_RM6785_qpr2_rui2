...
public class DeviceSettings extends PreferenceFragment
    ...
    public static final String KEY_FLASHLIGHT_BRIGHTNESS = "flashlight_brightness";
    public static final String FLASHLIGHT_BRIGHTNESS_NODE = "/sys/class/flashlight_core/flashlight/torch_brightness";
    ...
    public static SeekBarPreference mFlashlightBrightness;
	...
	mChargingSpeed = findPreference(KEY_CHARGING_SPEED);
        ...
        mFlashlightBrightness = findPreference(KEY_FLASHLIGHT_BRIGHTNESS);
        if (Utils.fileExists(FLASHLIGHT_BRIGHTNESS_NODE)) {
            mFlashlightBrightness.setEnabled(true);
            mFlashlightBrightness.setOnPreferenceChangeListener(this);
        } else {
            mFlashlightBrightness.setEnabled(false);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mFlashlightBrightness) {
            int brightness = (Integer) newValue;
            Utils.setValue(FLASHLIGHT_BRIGHTNESS_NODE, brightness);
        }
