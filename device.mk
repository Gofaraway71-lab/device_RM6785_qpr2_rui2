...
$(call inherit-product-if-exists, packages/apps/ViperFX/config.mk)
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/av/services/mediacodec/seccomp_policy/mediacodec-arm64.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy \
